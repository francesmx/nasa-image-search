 ...
 * Credit: https://medium.com/@johnmcdowell0801/testing-rtk-query-with-jest-cdfa5aaf3dc1
 */

// This is a helper function for creating a store during tests
// It returns an object {api, store} where api is the RTK Query service
// that you pass in, and store is the redux store that is created.

// We make use of it in the custom render function created in test-utils.jsx
